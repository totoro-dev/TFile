...
//		top.totoro.file.TException.setDebug(true);
		new top.totoro.file.sys.AndroidEnv();
		TFile.builder().toDisk(Disk.C)
		.toPath("tfile,test,main").toName("totoro.htm").toFile().create().setFlagFile("totoro");
		TFile.builder().toNames("t1.t","t2.t","t3.t").toFiles().createAll();
		String path = "tfile,test,main";
		TFile.builder().toPaths(path+",a;"+path+",b;"+path+",c");
		TFile.builder().toNames("t4.t","t5.t","t6.t").toFiles().createAll();
